...
function ProductDetail() {
  ...
  const handleChat = () => {
    ...
    navigate(`/chat/${listing.sellerId._id}`);
  };
    ...
    return (
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-screen-2xl mx-auto px-6 py-10">
          <div className="animate-pulse grid grid-cols-2 gap-10">
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-screen-2xl mx-auto px-6 py-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 bg-white rounded-xl p-6 shadow-sm mb-6">
          ...
          <div>
            {/* Main image */}
            <div className="w-full h-96 bg-gray-100 rounded-xl overflow-hidden flex items-center justify-center mb-3">
          ...
          <div className="flex flex-col gap-4">
            ...
            {listing.subtitle && (
              <p className="text-sm text-gray-500">{listing.subtitle}</p>
            )}
            ...
            <div className="flex flex-col gap-3 mt-2">
              ...
              <button className="w-full bg-yellow-400 hover:bg-yellow-500 text-gray-900 py-3 rounded-full font-semibold text-sm transition">
                Add to cart
              </button>
              <button
                onClick={handleChat}
